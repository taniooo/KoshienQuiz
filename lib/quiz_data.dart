...
class QuizData {
  ...
  static List<List> quizList = [
    ...
    [
      ...
      ['斎藤佑樹の出身校といえば？', '早稲田実業', '横浜', '駒大苫小牧', '常総学院', 'A'],
      [
        '公式戦で使用が認めらていないバットは？',
        '竹の接合バット',
        '木製バット',
      ...
      [
        '次のうち、現在の夏の甲子園の対戦方式についての説明として、誤っているものはどれ？',
        'トーナメント方式である',
        '一部、リーグ戦を導入している',
        '対戦の組合せを決める抽選のくじを引く順番を決めるための抽選がある',
        '準々決勝以降、勝利したチームは再度抽選を行い、組合せを決める',
        'B'
      ],
    ],
    [
    ...
    [
      ...
      [
        '第88回(2006年)全国高等学校野球選手権大会の決勝戦において、田中将大を擁する駒大苫小牧と、'
            '斎藤佑樹を擁する早稲田実業の試合は、延長15回で決着がつかず、'
      ...
      [
        '第25回(1939年)全国中等学校優勝野球大会において、海草中の優勝投手、嶋清一が'
            '達成していないのは？',
        '全試合完封勝利',
        '完全試合',
        '決勝でノーヒットノーラン',
      ...
      [
        '次のうち、甲子園に創部1年目(春の場合は創部翌年)で出場を果たした高校は？',
        '創志学園',
        '総合技術',
        '加古川北',
        '前橋育英',
      ...
      [
        '第43回(1961年)全国高等学校野球選手権大会の一回戦、報徳学園対倉敷工の試合は、'
            '0-0のまま延長戦に突入し、11回表に倉敷工が6点を先取した。'
            '11回裏の攻撃で、報徳学園は何点返したか？',
        '0',
        '5',
        '6',
        '7x',
      ...
      [
        '第35回(1953年)全国高等学校野球選手権大会の一回戦、慶応対北海の試合の説明として、'
            '正しくないのは次のうちどれ？',
        '勝利チームが無安打',
        '得点がタイムリーエラーによるもののみ',
        '両チーム合わせて1安打',
    ...
    [
      ...
      [
        '戦後、全国高等学校野球選手権大会の参加枠から削除された地域として、正しくないものは？',
        '南樺太',
        '朝鮮',
        '満州',
        '台湾',
      ...
      [
        '全国中等学校優勝野球大会において、敗者復活制度が導入されていたのは、第何回大会か？',
        '第1回から第3回',
        '第1回と第2回',
        '第1回と第3回',
        '第2回と第3回',
      ...
      [
        '「甲子園」の名前の由来は？',
        '球場が完成した年の十干(甲)、十二支(子)にちなんで',
        '「六甲山」の地名にちなんで',
        '末永く愛される球場になるよう、「亀は万年」の縁起をかついで',
      ...
      ['次のうち、夏の甲子園で優勝したことがある都道府県は？', '岡山県', '山梨県', '長野県', '島根県', 'C'],
      ...
      [
        '夏の甲子園で2連覇を達成した高校(一部)を時系列順に並べたとき、正しい順番は次のうちどれか？',
        '広島商、海藻中(向陽)、小倉中(小倉)',
        '海藻中(向陽)、広島商、小倉中(小倉)',
        '広島商、小倉中(小倉)、海藻中(向陽)',
        '小倉中(小倉)、広島商、海藻中(向陽)',
      ...
      ['次のうち、春の甲子園で一度も優勝のない都道府県は？', '千葉', '奈良', '大分', '福井', 'A'],
    ],
  ];
}
